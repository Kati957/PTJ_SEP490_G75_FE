...
const ProfileSidebar: React.FC = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      <Menu mode="vertical" selectedKeys={[location.pathname]} style={{ borderRight: 0 }}>
        ...
        <Menu.Item key="/nha-tuyen-dung-theo-doi" icon={<HeartOutlined />}>
          <NavLink to="/nha-tuyen-dung-theo-doi">
            <span className="font-semibold">Nhà tuyển dụng theo dõi</span>
            <div className="text-xs text-gray-500">Danh sách đã theo dõi</div>
          </NavLink>
        </Menu.Item>
